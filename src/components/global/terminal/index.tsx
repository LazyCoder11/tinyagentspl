...
const Terminal = () => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto relative p-4 rounded-2xl border border-foreground">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-1">
              ...
              <TypewriterEffectSmooth cursorClassName="bg-[#5fb9b0]" className="font-space-grotesk text-3xl" words={words} />
          ...
          <div className="space-y-2">
            ...
            <div className="gap-4 grid grid-cols-2">
              <div className="bg-[#5fb9b0]/20 border-foreground border p-4 rounded-lg flex justify-between items-center">
                <span className="text-yellow-400 mr-4 font-mono">$ agents</span>
                <span className="text-gray-400">List all available agents</span>
              </div>
              <div className="bg-[#5fb9b0]/20 border-foreground border p-4 rounded-lg flex justify-between items-center">
              ...
              <div className="bg-[#5fb9b0]/20 col-span-2 border-foreground border p-4 rounded-lg flex justify-between items-center">
